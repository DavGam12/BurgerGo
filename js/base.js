...
const printData = (data) => {
    ...
    Array.from(data).forEach(e => {
        ...
        mainCard.classList.add("test")
        listEmployees.appendChild(mainCard)
        const productIdSpan = mainCard.appendChild(document.createElement("span"))
        productIdSpan.textContent = e._productID
        const productNameSpan = mainCard.appendChild(document.createElement("span"))
        productNameSpan.textContent = e._productName
    ...
    /*
    const listEmployees = document.getElementById("employees-list")
    console.log("elemento #employees-list", listEmployees)
    const mainCard = document.createElement("div")
    mainCard.classList.add("test")
    listEmployees.appendChild(mainCard)
    const employeeIdSpan = mainCard.appendChild(document.createElement("span"))
    employeeIdSpan.textContent = dataEmployee._employeeID
    const employeeNameSpan = mainCard.appendChild(document.createElement("span"))
    employeeNameSpan.textContent = "name"
    const employeeSalarySpan = mainCard.appendChild(document.createElement("span"))
    employeeSalarySpan.textContent = "salary"
    */
