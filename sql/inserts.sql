...
begin
    insert into employees values (1, 'Emily', 'Smith', 'EmilySmith@gmail.com','891264309578',  '1990-05-12', '2024-04-22', 1450, 0, 'a2B!c4D?5', 1);
    insert into employees values (2, 'Michael', 'Johnson', 'MichaelJohnson@gmail.com','725046831294',   '1985-09-23', '2024-04-23', 1450, 0, '6eFgH!7?8', 1);
    insert into employees values (3, 'Jennifer', 'Williams', 'JenniferWilliams@gmail.com','630815924367',  '1983-12-31', '2024-04-24', 1450, 0, 'i9JkL?01m', 1);
    insert into employees values (4, 'Christopher', 'Brown', 'ChristopherBrown@gmail.com','492678301546',  '1992-03-17', '2024-04-25', 1450, 0, 'N23oP!45q', 1);
    insert into employees values (5, 'Jessica', 'Jones', 'JessicaJones@gmail.com','185703496237',  '1994-07-08', '2024-04-26', 1450, 0, 'T67uVw?89', 1);
    insert into employees values (6, 'Matthew', 'Davis', 'MatthewDavis@gmail.com','762935804216',  '1988-10-22', '2024-04-27', 1450, 0, 'yZ10!AB12?', 1);
    insert into employees values (7, 'Ashley', 'Miller', 'AshleyMiller@gmail.com','531907824613',  '1986-06-15', '2024-04-28', 1450, 0, 'cD34eF!56', 1);
    insert into employees values (8, 'Joshua', 'Wilson', 'JoshuaWilson@gmail.com','924386175093',  '1993-09-30', '2024-04-29', 1450, 0, 'H78iJK?90', 1);
    insert into employees values (9, 'Amanda', 'Moore', 'AmandaMoore@gmail.com','364891275030',  '1995-02-14', '2024-04-30', 1450, 0, 'm12NOp!34Q', 1);
    insert into employees values (10, 'Daniel', 'Taylor', 'DanielTaylor@gmail.com','207685913420',  '1991-08-07', '2024-05-01', 1450, 0, 'rS56tUV?78', 1);
    insert into employees values (11, 'Sarah', 'Anderson', 'SarahAnderson@gmail.com','805946312708',  '1989-04-20', '2024-05-02', 1450, 0, 'W90xYZ!12', 1);
    insert into employees values (12, 'David', 'Thomas', 'DavidThomas@gmail.com','652094187563',  '1984-11-03', '2024-05-03', 1450, 0, '34ABcD?56e',1);
    insert into employees values (13, 'Samantha', 'Jackson', 'SamanthaJackson@gmail.com','419368527014',  '1987-07-17', '2024-05-04', 1450, 0, 'F78gHI!90', 1);
    insert into employees values (14, 'James', 'White', 'JamesWhite@gmail.com','935761802643',  '1996-01-30', '2024-05-05', 1450, 0, 'J12kLM?34', 1);
    insert into employees values (15, 'Elizabeth', 'Harris', 'ElizabethHarris@gmail.com','273890561742',  '1982-05-24', '2024-05-06', 1450, 0, 'No56Pq!78R', 1);
    insert into employees values (16, 'Ryan', 'Martin', 'RyanMartin@gmail.com','617439280154',  '1990-08-15', '2024-05-07', 1450, 0, 'X34Yz!56AB', 1);
    insert into employees values (17, 'Lauren', 'Thompson', 'LaurenThompson@gmail.com','539178264301',  '1988-12-28', '2024-05-08', 1450, 0, 'Cd78Ef?90G', 1);
    insert into employees values (18, 'John', 'Martinez', 'JohnMartinez@gmail.com','873902416538',  '1993-03-10', '2024-05-09', 1450, 0, 'sT90UvW?12', 1);
    insert into employees values (19, 'Brittany', 'Garcia', 'BrittanyGarcia@gmail.com','426719583012',  '1986-10-04', '2024-05-10', 1450, 0, 'H12iJK!34', 1);
    insert into employees values (20, 'Nicholas', 'Robinson', 'NicholasRobinson@gmail.com','960318475629',  '1984-02-18', '2024-05-11', 1450, 0, 'lm56NOp?78', 1);
    insert into employees values (21, 'Megan', 'Lewis', 'MeganLewis@gmail.com','741082936175',  '1992-06-09', '2024-05-12', 1450, 0, 'aB2!cD?e3F', 1);
    insert into employees values (22, 'Andrew', 'Walker', 'AndrewWalker@gmail.com','749305816427',  '1990-07-05', '2024-04-22', 1100, 0, 'G4hI!5Jk?L6', 2);
    insert into employees values (23, 'Taylor', 'Hill', 'TaylorHill@gmail.com','630918275046',  '1988-02-14', '2024-04-23', 1100, 0, '7mNpO!q8Rs', 2);
    insert into employees values (24, 'Brandon', 'Scott', 'BrandonScott@gmail.com','184092753618',  '1993-05-22', '2024-04-24', 1100, 0, 'T9uV!wX?10y', 2);
    insert into employees values (25, 'Rachel', 'King', 'RachelKing@gmail.com','542897631804',  '1985-11-30', '2024-04-25', 1100, 0, 'Z11AB!cd?12', 2);
    insert into employees values (26, 'Justin', 'Green', 'JustinGreen@gmail.com','937618245093',  '1991-09-17', '2024-04-26', 1100, 0, 'eF13gHI!14J', 2);
    insert into employees values (27, 'Nicole', 'Hall', 'NicoleHall@gmail.com','351782946013',  '1989-04-02', '2024-04-27', 1100, 0, 'K15Lm?16NoP', 2);
    insert into employees values (28, 'Robert', 'Adams', 'RobertAdams@gmail.com','267819304576',  '1992-08-14', '2024-04-28', 1100, 0, 'Q17rS!tUV?18', 2);
    insert into employees values (29, 'Amber', 'Wright', 'AmberWright@gmail.com','689143275086',  '1987-01-25', '2024-04-29', 1100, 0, 'W19xYZ!20AB', 2);
    insert into employees values (30, 'Jonathan', 'Mitchell', 'JonathanMitchell@gmail.com','901542637189',  '1995-03-11', '2024-04-30', 1100, 0, 'cD21eF?22G', 2);
    insert into employees values (31, 'Kayla', 'Perez', 'KaylaPerez@gmail.com','409275816324',  '1986-12-18', '2024-05-01', 1100, 0, 'H23iJK!24Lm', 2);
    insert into employees values (32, 'William', 'Ortiz', 'WilliamOrtiz@gmail.com','176245389012',  '1993-07-07', '2024-05-02', 1100, 0, '25NOp?26qrS', 2);
    insert into employees values (33, 'Stephanie', 'Lee', 'StephanieLee@gmail.com','274159083726',  '1988-11-19', '2024-05-03', 1100, 0, 'T27UvW!28xY', 2);
    insert into employees values (34, 'Joseph', 'Young', 'JosephYoung@gmail.com','736925481037',  '1990-04-14', '2024-05-04', 1100, 0, 'Z29!ABcD?30', 2);
    insert into employees values (35, 'Cassandra', 'Torres', 'CassandraTorres@gmail.com','815032469871',  '1994-08-27', '2024-05-05', 1100, 0, 'eF31gHI!32Jk', 2);
    insert into employees values (36, 'Kyle', 'Rodriguez', 'KyleRodriguez@gmail.com','503276189542',  '1985-06-03', '2024-05-06', 1100, 0, 'L33mNo?34Pq', 2);
    insert into employees values (37, 'Heather', 'Rivera', 'HeatherRivera@gmail.com','792635180497',  '1992-09-10', '2024-05-07', 1330, 0, 'R35sTU!vW?36', 3);
    insert into employees values (38, 'Benjamin', 'Evans', 'BenjaminEvans@gmail.com','503819274856',  '1994-02-28', '2024-05-08', 1330, 0, 'X37YZ!abCD?', 3);
    insert into employees values (39, 'Melissa', 'Cook', 'MelissaCook@gmail.com','275631804925',  '1987-07-15', '2024-05-09', 1330, 0, 'eF38gHI!39Jk', 3);
    insert into employees values (40, 'Tyler', 'Turner', 'TylerTurner@gmail.com','618490235761',  '1991-11-22', '2024-05-10', 1330, 0, 'L40mNo?41Pq', 3);
    insert into employees values (41, 'Victoria', 'Phillips', 'VictoriaPhillips@gmail.com','435271908634',  '1989-04-05', '2024-05-11', 1330, 0, '1aB?c2D!e3F', 3);
    insert into employees values (42, 'Zachary', 'Cruz', 'ZacharyCruz@gmail.com','897654321098',  '1993-08-18', '2024-05-12', 1330, 0, '4GhI5!Jk?L6m', 3);
    insert into employees values (43, 'Rebecca', 'Bailey', 'RebeccaBailey@gmail.com','729503816245',  '1986-05-30', '2024-05-13', 1330, 0, '7N8oP!q9RsT', 3);
    insert into employees values (44, 'Jacob', 'Price', 'JacobPrice@gmail.com','372891054638',  '1990-12-07', '2024-05-14', 1330, 0, '10uV!wX11yZ12', 3);
    insert into employees values (45, 'Michelle', 'Reed', 'MichelleReed@gmail.com','918406725391',  '1988-10-12', '2024-05-15', 1330, 0, 'ABcD!eF13gHI', 3);
    insert into employees values (46, 'Ethan', 'Hayes', 'EthanHayes@gmail.com','640928571364',  '1996-03-25', '2024-05-16', 1330, 0, '14JkLm?15NoP', 3);
    insert into employees values (47, 'Kaitlyn', 'Foster', 'KaitlynFoster@gmail.com','536097281453',  '1985-11-19', '2024-05-17', 1330, 0, 'q16rS!tUV?17', 3);
    insert into employees values (48, 'Alexander', 'Murphy', 'AlexanderMurphy@gmail.com','325890416372',  '1983-06-28', '2024-05-18', 1330, 0, '18WxYZ!19ABcD', 3);
    insert into employees values (49, 'Emily', 'Nelson', 'EmilyNelson@gmail.com','789623501847',  '1998-01-15', '2024-05-19', 1330, 0, 'eF20gHI!21JkL', 3);
    insert into employees values (50, 'Kevin', 'Barnes', 'KevinBarnes@gmail.com','924681037596',  '1986-09-08', '2024-05-20', 1330, 0, 'm22No?P23qRs', 3);
    insert into employees values (51, 'Olivia', 'Coleman', 'OliviaColeman@gmail.com','162740953817',  '1990-04-20', '2024-05-21', 1330, 0, 'T24UvW!25xYZ', 3);
    insert into employees values (52, 'Brian', 'Bennett', 'BrianBennett@gmail.com','482630175984',  '1993-02-17', '2024-05-22', 1110, 0, '26ABcD?eF27', 4);
    insert into employees values (53, 'Emma', 'Powell', 'EmmaPowell@gmail.com','597823014856',  '1988-08-29', '2024-05-23', 1110, 0, '28gHI29Jk?L30', 4);
    insert into employees values (54, 'Timothy', 'Rogers', 'TimothyRogers@gmail.com','376982045813',  '1985-12-10', '2024-05-24', 1110, 0, 'mNo31P!q32rST', 4);
    insert into employees values (55, 'Allison', 'Ross', 'AllisonRoss@gmail.com','239687510384',  '1991-06-03', '2024-05-25', 1110, 0, 'UV33wX!34yZAB', 4);
    insert into employees values (56, 'Cody', 'Russell', 'CodyRussell@gmail.com','981402367815',  '1989-11-14', '2024-05-26', 1110, 0, 'cD35eF?36gHI', 4);
    insert into employees values (57, 'Morgan', 'Hayes', 'MorganHayes@gmail.com','547893216704',  '1995-04-27', '2024-05-27', 1110, 0, 'J37kLm!38NoP', 4);
    insert into employees values (58, 'Patrick', 'Collins', 'PatrickCollins@gmail.com','654987320146',  '1983-09-05', '2024-05-28', 1950, 1, 'q39rS?40tUVW', 5);
    insert into employees values (59, 'Hannah', 'Bell', 'HannahBell@gmail.com','821403976582',  '1987-03-12', '2024-05-29', 1950, 1, 'x41YZ!ABcD?e', 5);
    insert into employees values (60, 'Steven', 'Cooper', 'StevenCooper@gmail.com','405978613294',  '1984-07-18', '2024-05-30', 1950, 1, 'F42gHI!43JkLm', 5);
    insert into employees values (61, 'Erica', 'Jenkins', 'EricaJenkins@gmail.com','136985720489',  '1986-11-23', '2024-05-31', 1950, 1, '1aB?c2D!e3F4', 5);
    insert into employees values (62, 'Gregory', 'Ward', 'GregoryWard@gmail.com','792041836590',  '1982-05-09', '2024-06-01', 1950, 1, '9N10oP!qRsTU', 5);
    insert into employees values (63, 'Caitlin', 'Hughes', 'CaitlinHughes@gmail.com','569283047615',  '1989-01-30', '2024-06-02', 1950, 1, 'V11wX!yZAB12', 5);
    insert into employees values (64, 'Samuel', 'Griffin', 'SamuelGriffin@gmail.com','927365148023',  '1981-08-14', '2024-06-03', 1880, 0, 'eF26gHI!JkL27', 6);
    insert into employees values (65, 'Jenna', 'Sullivan', 'JennaSullivan@gmail.com','731920468517',  '1980-12-03', '2024-06-04', 1880, 0, 'HI34JkLm!35No', 6);
    insert into employees values (66, 'Nathan', 'Diaz', 'NathanDiaz@gmail.com','513892047615',  '1978-06-22', '2024-06-05', 1880, 0, 'mNo?P42qRs43', 6);
exception
    when others then
    rollback;
end;
