...
create table customers(customer_id number(8) primary key, first_name varchar2(40) not null, last_name varchar2(60), email varchar2(50) not null, phone_number varchar2(13) not null, password varchar2(40) not null);
...
create table products(product_id number(4) primary key, product_name varchar2(60) not null, product_img varchar2(100) not null, product_price number(4,2) not null, product_description varchar2(200) not null, category_id varchar2(2), foreign key(category_id) references categories(category_id));
