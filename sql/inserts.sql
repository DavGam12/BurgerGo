begin
    ...
    insert into categories values ('GF','Gluten free');
exception
    when others then
    rollback;
end;
...
begin
    insert into products values ('1','Simple beef', '../Images/Menu/simple-beef.png', 1.4, 'Beef burger, lettuce, tomato, pickles ketchup, and mustard.', 'BG');
    insert into products values ('2','Simple chicken', '../Images/Menu/simple-chicken.png', 1.5, 'Chicken burger, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('3','Simple fried chiken', '../Images/Menu/simple-fried-chicken.png', 1.8, 'Fried chicken burger, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('4','Double beef', '../Images/Menu/double-beef.png', 2.6, 'Double beef burger, lettuce, pickles, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('5','Double chicken', '../Images/Menu/double-chicken.png', 2.9, 'Double chicken burger, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('6','Double fried chicken', '../Images/Menu/double-fried-chicken.png', 3.4, 'Double fried chicken burger, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('7','Triple beef', '../Images/Menu/triple-beef.png', 3.5, 'Triple beef burger, lettuce, pickles, tomato, ketchup, and mustard.', 'BG');
    ...
    insert into products values ('9','Triple fried chicken', '../Images/Menu/triple-fried-chicken.png', 4.9, 'Triple fried chicken burger, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('10','Simple beef cheeseburger', '../Images/Menu/simple-beef-cheeseburger.png', 1.75, 'Beef burger, extra cheese, lettuce,  pickles, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('11','Simple chicken cheeseburger', '../Images/Menu/simple-chicken-cheeseburger.png', 1.8, 'Chicken burger, extra cheese, lettuce, tomato, ketchup, and mustard.', 'BG');    
    insert into products values ('12','Simple fried chicken cheeseburger', '../Images/Menu/simple-fried-chicken-cheeseburger.png', 2.1, 'Fried chicken burger, extra cheese, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('13','Double beef cheeseburger', '../Images/Menu/double-beef-cheeseburger.png', 3.3, 'Double beef burger, extra cheese, lettuce,  pickles, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('14','Double chicken cheeseburger', '../Images/Menu/double-chicken-cheeseburger.png', 3.5, 'Double chicken burger, extra cheese, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('15','Double fried chicken cheeseburger', '../Images/Menu/double-fried-chicken-cheeseburger.png', 4, 'Double fried chicken burger, extra cheese, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('16','Triple beef cheeseburger', '../Images/Menu/triple-beef-cheeseburger.png', 4.9, 'Triple beef burger, extra cheese, lettuce, pickles, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('17','Triple chicken cheeseburger', '../Images/Menu/triple-chicken-cheeseburger.png', 5.2, 'Triple chicken burger, extra cheese, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('18','Triple fried chicken cheeseburger', '../Images/Menu/triple-fried-chicken-cheeseburger.png', 5.5, 'Triple fried chicken burger, extra cheese, lettuce, tomato, ketchup, and mustard.', 'BG');
    insert into products values ('19','Simple beef BBQ', '../Images/Menu/simple-beef-bbq.png', 1.5, 'Beef burger, lettuce, tomato, pickles and homemade barbecue sauce..', 'BG');
    insert into products values ('20','Simple chicken BBQ', '../Images/Menu/simple-chicken-bbq.png', 1.6, 'Chicken burger, lettuce, tomato, and homemade barbecue sauce.', 'BG');
    insert into products values ('21','Simple fried chicken BBQ', '../Images/Menu/simple-fried-chicken-bbq.png', 1.9, 'Fried chicken burger, lettuce, tomato, and homemade barbecue sauce.', 'BG');
    insert into products values ('22','Double beef BBQ', '../Images/Menu/double-beef-bbq.png', 2.8, 'Double beef burger, lettuce, tomato, pickles and homemade barbecue sauce.', 'BG');
    insert into products values ('23','Double chicken BBQ', '../Images/Menu/double-chicken-bbq.png', 3, 'Double chicken burger, lettuce, tomato, and homemade barbecue sauce.', 'BG');
    insert into products values ('24','Double fried chicken BBQ', '../Images/Menu/double-fried-chicken-bbq.png', 3.6, 'Double fried chicken burger, lettuce, tomato, and homemade barbecue sauce.', 'BG');
    insert into products values ('25','Triple beef BBQ', '../Images/Menu/triple-beef-bbq.png', 4.2, 'Triple beef burger, lettuce, tomato, pickles and homemade barbecue sauce.', 'BG');
    insert into products values ('26','Triple chicken BBQ', '../Images/Menu/triple-chicken-bbq.png', 4.6, 'Triple chicken burger, lettuce, tomato, and homemade barbecue sauce.', 'BG');
    insert into products values ('27','Triple fried chicken BBQ', '../Images/Menu/triple-fried-chicken-bbq.png', 5.5, 'Triple fried chicken burger, lettuce, tomato, and homemade barbecue sauce.', 'BG');
    insert into products values ('28','Burger beef jr', '../Images/Menu/beef-jr.png', 1.2, 'Small beef burger with lettuce and a beef patty.', 'KM');
    insert into products values ('29','Burger chicken jr', '../Images/Menu/chicken-jr.png', 1.2, 'Small beef burger with lettuce and a chicken patty.', 'KM');
    insert into products values ('30','Burger fried chicken jr', '../Images/Menu/fried-chicken-jr.png', 1.2, 'Small beef burger with lettuce and a fried chicken patty.', 'KM');
    insert into products values ('31','Nuggies jr', '../Images/Menu/nuggets-jr.png', 1.5, '6 pieces of chicken nuggets.', 'KM');
    insert into products values ('32','Vanilla ice cream jr', '../Images/Menu/ice-cream-vanilla-jr.png', 1.1, 'One small vanilla ice cream cone.', 'KM');
    insert into products values ('33','Chocolate ice cream jr', '../Images/Menu/ice-cream-chocolate-jr.png', 1.1, 'One small chocolate ice cream cone.', 'KM');
    insert into products values ('34','Water bottle', '../Images/Menu/water.png', 1.3, 'A water bottle', 'DR');
    insert into products values ('35','Coke', '../Images/Menu/coke.png', 1.9, 'A can of coke.', 'DR');
    insert into products values ('36','Coke light', '../Images/Menu/coke-light.png', 1.9, 'A can of coke light.', 'DR');
    insert into products values ('37','Fanta lemon', '../Images/Menu/fanta-lemon.png', 1.9, 'A can of fanta lemon flavoured.', 'DR');
    insert into products values ('38','Fanta orange', '../Images/Menu/fanta-orange.png', 1.9, 'A can of fanta orange flavoured.', 'DR');
    insert into products values ('39','Beer', '../Images/Menu/beer.png', 2, 'A can of beer.', 'DR');
    insert into products values ('40','Sprite', '../Images/Menu/sprite.png', 1.9, 'A can of sprite.', 'DR');
    insert into products values ('41','Aquarius lemon', '../Images/Menu/aquarius-lemon.png', 1.9, 'A can of aquarius lemon flavoured.', 'DR');
    insert into products values ('42','Aquarius orange', '../Images/Menu/aquarius-orange.png', 1.9, 'A can of aquarius orange flavoured.', 'DR');
    insert into products values ('43','Apple pie', '../Images/Menu/apple-pie.png', 1.15, 'A sweet apple pie caramelised with sugar syrup.', 'DS');
    insert into products values ('44','Sliced apple', '../Images/Menu/apple.png', 1.9, 'A sliced apple.', 'DS');
    insert into products values ('45','Vanilla ice cream', '../Images/Menu/ice-cream-vanilla.png', 2.1, 'A cup of vanilla ice cream.', 'DS');
    insert into products values ('46','Chocolate ice cream', '../Images/Menu/ice-cream-chocolate.png', 2.1, 'A cup of chocolate ice cream.', 'DS');
    insert into products values ('47','Caramel ice cream', '../Images/Menu/ice-cream-caramel.png', 2.1, 'A cup of caramel ice cream.', 'DS');
    insert into products values ('48','Chicken nuggets', '../Images/Menu/chicken-nuggets.png', 6.7, '10 pieces of chicken nuggets.', 'OT');
    insert into products values ('49','Chicken wings', '../Images/Menu/chicken-wings.png', 8.4, '10 pieces of chicken wings.', 'OT');
    insert into products values ('50','French fries', '../Images/Menu/french-fries.png', 1.5, 'A bag of french fries.', 'OT');
    insert into products values ('51','French fries deluxe', '../Images/Menu/french-fries-deluxe.png', 1.6, 'A bag of french fries deluxe.', 'OT');
    insert into products values ('52','Ketchup', '../Images/Menu/ketchup.png', 0.5, 'A ketchup sauce package.', 'OT');
    insert into products values ('53','Mayonnaise', '../Images/Menu/mayonnaise.png', 0.5, 'A mayonnaise sauce package.', 'OT');
    insert into products values ('54','Barbecue', '../Images/Menu/barbecue.png', 0.5, 'A barbecue sauce package.', 'OT');
    insert into products values ('55','Ranch', '../Images/Menu/ranch.png', 0.5, 'A ranch sauce package.', 'OT');
    insert into products values ('56','Glutten free simple beef', '../Images/Menu/simple-beef.png', 1.4, 'A glutten free beef burger with lettuce, tomato, pickles ketchup, and mustard.', 'GF');
    insert into products values ('57','Glutten free simple chicken', '../Images/Menu/simple-chicken.png', 1.5, 'A glutten free chicken burger with lettuce, tomato, pickles ketchup, and mustard.', 'GF');
    insert into products values ('58','Glutten free simple fried chiken', '../Images/Menu/simple-fried-chicken.png', 1.8, 'A glutten free fried chicken burger with lettuce, tomato, pickles ketchup, and mustard.', 'GF');
    insert into products values ('59','Glutten free double beef', '../Images/Menu/double-beef.png', 2.6, 'A glutten free double beef burger with lettuce, tomato, pickles ketchup, and mustard.', 'GF');
    insert into products values ('60','Glutten free double chicken', '../Images/Menu/double-chicken.png', 2.9, 'A glutten free double chicken burger with lettuce, tomato, pickles ketchup, and mustard.', 'GF');
    insert into products values ('61','Glutten free double fried chicken', '../Images/Menu/double-fried-chicken.png', 3.4, 'A glutten free double fried chicken burger with lettuce, tomato, pickles ketchup, and mustard.', 'GF');
exception
    when others then
    rollback;
end;
